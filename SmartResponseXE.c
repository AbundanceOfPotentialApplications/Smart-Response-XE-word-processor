...
//
// 9/2021 changes by AbundanceOfPotentialApplicatons
//    - dropped the Arduino.h include, and adjusted as needed
//         to build without IDE, this may be temporary...
//    - changed interrupt to falling edge
//    - imported voltage/contrast control functions from
//         a fork of the library made by fdufnews
//    - added a function to check the power button press
//    - added defines for most keys (like K_UP etc.)
//    - adjusted the keyboard layout, in particular
//         shift+number gives the special characters too,
//         sym+arrows gives K_PGUP,K_HOME and so on,
//         and added a bunch of characters like @&^
...
// using the 16MHz crystal for transceiver
...
byte OriginalKeys[] = {'1','2','3','4','5','6','7','8','9','0',
                       'q','w','e','r','t','y','u','i','o','p',
                       'a','s','d','f','g','h','j','k','l',K_del,
                       0  ,'z','x','c','v','b','n', K_down,0,K_up, // 5 = down, 4 = up
                       0  ,K_enter,  0, '^',' ',',','.','m',  K_left, K_right, // 2 = left, 3 = right
                       K_F1,K_F2,K_F3,K_F4,K_F5,K_F6,K_F7,K_F8,K_F9,K_F10
                       };
byte ShiftedKeys[] =  {'!','@','#','$','%','&','\'','\"','(',')',
                       'Q','W','E','R','T','Y','U','I','O','P',
                       'A','S','D','F','G','H','J','K','L',K_enter,
                       0  ,'Z','X','C','V','B','N', K_down,0,K_up, // 5 = down
                       0  ,K_enter,  0,  0,'_',',','.','M',  K_left, K_right,
                       K_F1,K_F2,K_F3,K_F4,K_F5,K_F6,K_F7,K_F8,K_F9,K_F10};
byte SymKeys[] =       {'!','@','#','$','%','&','\'','\"','(',')',
                       'q','w','e','r','t','y','u','i','[',']',
                       '=','+','-','f','g','h',';',':','?',K_backspace,
                        0 ,'*','/','c','v','b','{',K_pgDown,0,K_pgUp,
                        0 ,K_enter, 0 , 0 ,'~','<','>','}', K_home, K_end, // 1 = menu
                       K_F1,K_F2,K_F3,K_F4,K_F5,K_F6,K_F7,K_F8,K_F9,K_F10};
...
byte uc, ucTemp[8];
  ...
  SRXEdelay(150); // datasheet says it must be at least 120ms
